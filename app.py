...
st.markdown("""
<div class="info-box">
    📱 <b>Accès mobile / للاستخدام على الهاتف:</b><br>
    Ouvrez sur votre téléphone: <code>http://192.168.1.107:8501</code>
</div>
""", unsafe_allow_html=True)
...
if uploaded is not None:
    with st.spinner("🔍 Analyse de l'image en cours..."):
        ...
        img_tensor = transform_unet(image=img)["image"].unsqueeze(0).to(unet_device)
