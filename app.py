...
if 'page' not in st.session_state:
    st.session_state.page = "home"  # "home" ou "history"
...
<style>
    ...
    * { font-family: 'Inter', 'Tajawal', sans-serif; }
    ...
    .header-logo-badge img { width: 100%; height: 100%; object-fit: contain; padding: 4px; }
    .header-icon-btn {
        width: 34px; height: 34px; border-radius: 50%;
        background: rgba(255,255,255,0.15);
        display: flex; align-items: center; justify-content: center;
        color: #ffffff; font-size: 15px; position: relative;
    }
    .header-icon-btn .dot {
        position: absolute; top: 4px; right: 4px;
        width: 8px; height: 8px; border-radius: 50%;
        background: #f87171; border: 1.5px solid #1e3a8a;
    }
    .header-badge {
    ...
    .header-badge strong { color: #2563eb; font-weight: 700; }
    @media (max-width: 700px) {
        .header { flex-direction: column; align-items: stretch; padding: 0.8rem 1rem; }
        .header-left { order: 1; justify-content: center; flex-wrap: wrap; }
        .header-badges { order: 2; justify-content: center; }
    ...
    .top-badge-card:hover { transform: translateY(-3px); box-shadow: 0 10px 24px rgba(30,58,138,0.1); }
    ...
    .top-badge-card .tb-title { font-weight: 700; font-size: 13px; color: #0f172a; }
    .top-badge-card .tb-desc { font-size: 11px; color: #64748b; }
    ...
    .sidebar-glass p, .sidebar-glass li { color: #334155; font-size: 14px; line-height: 1.6; }
    .sidebar-glass ul { padding-left: 1.2rem; }
    .sidebar-glass .qr-container { display: flex; justify-content: center; margin: 0.8rem 0; }
    ...
    .sidebar-glass .qr-container img:hover { transform: scale(1.05); }
    ...
    .hero:hover { box-shadow: 0 20px 48px rgba(30,58,138,0.32); }
    .hero .icon { font-size: 40px; animation: float 3s ease-in-out infinite; display: inline-block; }
    @keyframes float { 0%, 100% { transform: translateY(0); } 50% { transform: translateY(-10px); } }
    .hero h1 {
        font-size: 34px; font-weight: 800; color: #ffffff;
        margin: 0.5rem 0 0.2rem; line-height: 1.3;
    }
    .hero h1 span { color: #FCD34D; }
    .hero p { font-size: 16px; color: #dbeafe; margin: 0.5rem 0 1.4rem; max-width: 480px; }
    .hero .hero-badge {
    ...
    .doctor-image {
        ...
        transition: transform 0.3s ease;
        width: 100%; max-width: 320px; object-fit: contain;
    }
    .doctor-image:hover { transform: scale(1.02); }
    .hero-content {
    ...
    .hero-heartbeat {
        position: absolute; top: 50%; left: -10%; width: 60%;
        opacity: 0.4; transform: translateY(-50%); z-index: 1;
    }
    .hero-cta {
    ...
    .hero-cta:hover { transform: scale(1.04); box-shadow: 0 12px 32px rgba(245,158,11,0.5); }
    @media (max-width: 700px) {
    ...
    .scan-container img { width: 100%; display: block; border-radius: 16px; }
    .scan-line {
    ...
    .feature-card h4 { color: #0f172a; font-weight: 700; margin: 8px 0 4px; font-size: 16px; }
    .feature-card p { color: #64748b; font-size: 13px; margin: 0; }
    ...
    .how-step:hover .step-num { transform: scale(1.1) rotate(5deg); }
    .how-step h5 { color: #0f172a; font-weight: 700; margin: 0 0 4px; font-size: 16px; }
    .how-step p { color: #64748b; font-size: 14px; margin: 0; }
    
    .trust-section {
        display: flex; justify-content: center; gap: 30px;
        flex-wrap: wrap; margin: 1.5rem 0; padding: 1.5rem;
        background: rgba(255,255,255,0.6);
        backdrop-filter: blur(4px); border-radius: 20px;
        animation: fadeUp 1s ease;
    }
    .trust-item { display: flex; align-items: center; gap: 8px; font-weight: 600; color: #0f172a; font-size: 15px; }
    .trust-item .icon { font-size: 24px; }
    
    .result-card {
        border-radius: 24px; padding: 1.8rem; margin-top: 0.5rem;
    ...
    .result-card h2 { font-size: 30px; font-weight: 700; margin: 0 0 6px; }
    ...
    .stProgress > div > div > div > div {
        ...
        height: 12px !important; border-radius: 20px !important;
    ...
    .stButton > button {
        ...
        padding: 14px 32px; font-weight: 700; font-size: 16px;
    ...
    .upload-card .icon { font-size: 48px; animation: float 3s ease-in-out infinite; display: inline-block; }
    .upload-card h3 { font-weight: 700; color: #0f172a; margin: 10px 0 4px; font-size: 20px; }
    .upload-card p { color: #64748b; font-size: 14px; margin: 0; }
    ...
    .doctor-btn {
        ...
        cursor: not-allowed; opacity: 0.7; width: 100%;
        text-align: center; transition: all 0.3s ease;
        box-shadow: 0 4px 12px rgba(245,158,11,0.2);
        margin-top: 10px;
    }
    .doctor-btn:hover { opacity: 0.9; transform: scale(1.02); }
    .coming-badge {
        background: linear-gradient(135deg, #F59E0B, #D97706);
    ...
    .history-actions .stButton { flex: 1; min-width: 140px; }
    .history-count {
        display: inline-flex; align-items: center; gap: 8px;
    ...
    @media (max-width: 640px) {
        ...
        .history-actions .stButton { min-width: 100%; }
    }
</style>
...
# ============================================
    ...
    if st.session_state.history:
        ...
        <div style="display:flex; align-items:center; gap:16px; flex-wrap:wrap; margin-bottom:16px;">
            <span class="history-count">📋 {len(st.session_state.history)} {t('history_title')}</span>
            <span style="color:#94a3b8; font-size:14px;">
                {t('history_date')} : {st.session_state.history[-1]['Date'] if st.session_state.history else ''}
            </span>
        </div>
        """, unsafe_allow_html=True)
        ...
        with col_hist3:
            # إحصائية سريعة
            anemic_count = sum(1 for h in st.session_state.history if h['Diagnostic'] == 'Anemic')
            total = len(st.session_state.history)
            st.metric("🩸", f"{anemic_count}/{total}", delta=f"{anemic_count/total*100:.0f}%" if total > 0 else "0%")
    else:
        st.markdown(f"""
        <div class="history-empty">
            <span class="icon">📭</span>
            {t('history_empty')}
            <p style="font-size:14px; margin-top:8px; color:#b0b8c4;">
                قم بتحليل صورة أولاً لتظهر هنا.
            </p>
        </div>
        """, unsafe_allow_html=True)
